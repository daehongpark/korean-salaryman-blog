...
def _build_thread_prompt(post: dict) -> str:
    ...
    return (
        ...
        "- 첫 문장이 전부다. 스크롤 멈추는 한 방. 그 뒤는 1~2문장 여운만.\n"
        ...
        "- 길이: ★ 150자 이내, 2~3문장. 짧고 강하게. 설명하지 말고 궁금하게 끊어라.\n\n"
...
def _reply_link_text(url: str) -> str:
    """본문에 달 답글(링크) 텍스트 — 반말·이모지 없이, 매번 랜덤."""
    return random.choice(_REPLY_LINK_TEMPLATES).format(url=url)
