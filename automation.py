...
def build_prompt(category: str, keyword: str, seo_meta: dict | None = None) -> str:
    ...
    # ── 톤 지시 ─────
    tone_directives = {
        "objective":   "객관 정보 위주 - 1인칭 최소화, 정부 공식 발표/통계 인용 권장",
        "practical":   "실전 위주 - 직접 사용 시나리오, 단계별 캡처 묘사",
        "data_driven": "숫자/근거 중심 - 모든 주장에 수치 첨부, 출처 명시",
        "balanced":    "객관 정보 70% + 경험/팁 30%",
        "analytical":  "분석적 - 인과관계 명확히, 단정적 표현 자제",
    }
...
[톤 가이드]
- {tone_directive}
- "안녕하세요" 같은 의례적 인사 절대 금지
- "결론적으로", "요약하자면" 같은 AI 티 나는 표현 금지
