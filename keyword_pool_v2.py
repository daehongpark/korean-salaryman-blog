...
KEYWORD_POOL_V2 = {
    ...
    "ai": [
        ...
        "2026 최신 AI 모델 비교", "Claude vs ChatGPT vs Gemini 업무별 추천",
        "직장인 보고서 작성 최강 AI", "AI 코딩 도구 비교 2026",
        "무료 AI 이미지 생성 비교", "AI 검색 서비스 비교 2026",
        "용도별 최강 AI 정리 2026", "엑셀 작업 최강 AI 비교",
        "PPT 자동 생성 AI 비교", "회의록 정리 AI 추천",
        "긴 문서 요약 AI 비교", "번역 품질 좋은 AI 비교",
        "코드 리뷰 AI 도구 비교", "AI 노트앱 비교 2026",
        ...
        "국산 AI 서비스 비교 2026", "최신 AI 에이전트 도구 정리",
        "AI 발표자료 디자인 도구 비교", "AI 챗봇 성능 비교 2026",
        "무료로 쓰는 AI 도구 모음 2026", "직장인 AI 구독료 가성비 비교",
        "코딩 어시스턴트 AI 비교 2026", "회사 보안 지키며 AI 쓰는 법",
    ],
    "startup": [
    ...
    "finance": [
        ...
        "달러 투자 전략 2026", "퇴직연금 운용 방법", "DC형 DB형 차이",
