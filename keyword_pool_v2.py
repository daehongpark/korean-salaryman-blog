...
KEYWORD_POOL_V2 = {
    ...
    "trending": [
        # 커리어/이직/연봉 (★ 박대홍 5/17 - 직장인이 가장 관심)
        "2026 직장인 연봉 인상률", "이직 시기 직장인", "퇴사 후 실업급여 변경",
        "경력직 이직 시장 흐름", "직장인 성과급 평균",
        # 직장 문화/세대
        "MZ세대 직장 문화", "꼰대 vs 라떼", "회식 문화 변화",
        "주 4일제 도입 기업", "유연근무제 의무화",
        # 건강/번아웃/멘탈
        "직장인 번아웃 회복", "직장인 정신건강 보험", "퇴근 후 운동 루틴",
        "직장인 수면 부족 해결",
        # 가족/육아/결혼
        "직장인 육아휴직 2026", "맞벌이 부부 세금 혜택", "신혼부부 정책",
        "직장인 결혼 비용 절약",
        # 세금/연말정산
        "2026 연말정산 변경점", "직장인 세액공제 신설", "연봉별 세금 차이",
        # 정책 핫이슈 (계속 유지)
        "2026 새 정책 시행", "최저임금 2026 인상", "세법 개정안 영향",
        # IT/서비스 트렌드 (직장인 실용)
        "AI 업무 자동화 트렌드", "재택근무 도구 2026",
    ],
    "book": [
        # 자기계발 고전
