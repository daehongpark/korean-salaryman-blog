...
KEYWORD_POOL_V2 = {
    "money": [
        "2026 청년정책 모음", "청년도약계좌 가입조건", "청년도약계좌 중도해지",
        ...
        "국민연금 추납 제도", "실업급여 조건 2026", "직장인 절세 꿀팁",
    ],
    "ai": [
        "AI로 회의록 자동 정리", "AI 이메일 답장 작성", "AI 보고서 초안 만들기",
        "엑셀 함수 AI로 해결", "AI 파워포인트 자동 생성", "ChatGPT 업무 활용 실전",
        "Claude 긴 문서 요약", "Claude Code 기초 사용법", "Claude Code 설치 방법",
        "Gemini 자료조사 활용", "AI로 PDF 요약하기", "노션 AI 활용법",
        "ChatGPT 처음 시작하기", "AI 챗봇 기초 입문", "프롬프트 잘 쓰는 법",
        "AI 글쓰기 검수 활용", "AI로 시장조사 하기", "사업 아이디어 AI 검증",
        "AI로 사업계획서 작성", "1인 사업자 AI 활용", "AI 고객응대 자동화",
        "AI 마케팅 카피 작성", "업무 자동화 n8n 입문", "Zapier 실무 예시",
        "AI 코드 없이 앱 만들기", "최신 AI 도구 소개 2026", "새로 나온 AI 서비스",
        "국산 AI 서비스 비교", "AI 이미지 실무 활용", "AI 영상 편집 도구",
        "GPT 커스텀 만들기", "AI 데이터 분석 입문", "회사에서 AI 쓰기 보안",
        "AI 부업 현실적 방법", "AI 자동화 수익 사례", "직장인 AI 학습 로드맵",
        "무료 AI 도구 모음 2026", "AI 회의 통역 활용",
    ],
    "startup": [
        "직장인 부업 추천 2026", "직장인 사업자등록 방법", "부업 종합소득세 신고",
    ...
    "finance": [
        ...
        "월배당 ETF 직장인", "직장인 ETF 시작하기", "ISA 계좌 200% 활용",
        "ISA vs 연금저축 vs IRP", "연금저축 세액공제 한도", "IRP 직장인 절세",
        "연금저축 갈아타기", "고금리 적금 비교 2026", "파킹통장 금리 비교",
        "직장인 종합소득세", "배당소득세 절세", "금 투자 방법 2026",
        "달러 투자 입문", "퇴직연금 운용 방법", "DC형 DB형 차이",
        "연말정산 카드 공제", "월급 통장 쪼개기", "비상금 마련 전략",
        "직장인 대출 갈아타기", "신용점수 올리는 법", "재테크 초보 순서",
    ...
    "realestate": [
        "2026 주택청약 1순위 조건", "청약통장 납입 인정액", "특별공급 자격 총정리",
        "신생아 특공 조건", "신혼부부 특별공급", "생애최초 특별공급",
        "공공분양 사전청약", "디딤돌대출 조건 2026", "버팀목 전세자금대출",
        "보금자리론 자격", "전세 보증금 반환보증", "전세사기 예방법",
        ...
        "전월세 신고제 의무", "오피스텔 투자 주의", "분양가 상한제 단지",
        "청약 가점 계산법", "무순위 줍줍 청약", "임장 체크리스트",
        "부동산 시장 분위기 읽기",
    ],
    "trending": [
        ...
        "직장인 연차 활용", "직장인 인간관계", "2026 직장인 연봉 인상률",
