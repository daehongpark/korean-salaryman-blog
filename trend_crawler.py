...
CATEGORY_DATALAB_GROUPS = {
    ...
    # trending 씨앗은 "고정 발행 리스트"가 아니라 수집 방향(돈·정책·혜택) 힌트다.
    # 실시간 트렌드/최신 뉴스가 우선이고, 씨앗에 없는 핫한 주제도 그대로 채택한다.
    # 라이프스타일(번아웃/운동/회식/MZ)은 발행구조 Phase 2(2026-07-23)에서 제외.
    "trending": [
        {"groupName": "물가금리",    "keywords": ["물가상승", "기준금리", "환율"]},
        {"groupName": "고용소득",    "keywords": ["최저임금", "연봉인상", "실업급여"]},
        {"groupName": "세금정책",    "keywords": ["연말정산", "종합소득세", "건강보험료"]},
        {"groupName": "부동산이슈",  "keywords": ["대출규제", "분양", "청약"]},
        {"groupName": "지원정책",    "keywords": ["청년지원금", "신혼부부 지원", "특례대출"]},
    ],
